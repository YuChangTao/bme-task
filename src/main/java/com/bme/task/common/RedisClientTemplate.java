...
public class RedisClientTemplate {
	...
	public void set(String key, Object value) {
		...
		opsForValue.set(key, json(value));
	}
	...
	/**
	 * 设置ASCII码, 字符串'EmissionControlMapper'的ASCII码是97, 转为二进制是'01100001', 此方法是将二进制第offset位值变为value
	 *
	 * @param key
	 * @param postion
	 *            位置
	...
	public String lRightPopAndLeftPush(String sourceKey, String destinationKey) {
		return opsForList.rightPopAndLeftPush(sourceKey,
				destinationKey);
	}
	...
	public Long sIntersectAndStore(String key, String otherKey, String destKey) {
		return opsForSet.intersectAndStore(key, otherKey,
				destKey);
	}
	...
	public Long sIntersectAndStore(String key, Collection<String> otherKeys,
			String destKey) {
		return opsForSet.intersectAndStore(key, otherKeys,
				destKey);
	}
	...
	public Long sDifference(String key, String otherKey, String destKey) {
		return opsForSet.differenceAndStore(key, otherKey,
				destKey);
	}
	...
	public Long sDifference(String key, Collection<String> otherKeys,
			String destKey) {
		return opsForSet.differenceAndStore(key, otherKeys,
				destKey);
	}
	...
	public Set<TypedTuple<String>> zReverseRangeWithScores(String key,
                                                           long start, long end) {
		return opsForZSet.reverseRangeWithScores(key, start,
				end);
	}
	...
	public Set<TypedTuple<String>> zReverseRangeByScoreWithScores(
		...
		return opsForZSet.reverseRangeByScoreWithScores(key,
				min, max);
	}
	...
	public Long zIntersectAndStore(String key, String otherKey,
			String destKey) {
		return opsForZSet.intersectAndStore(key, otherKey,
				destKey);
	}
	...
	public Long zIntersectAndStore(String key, Collection<String> otherKeys,
			String destKey) {
		return opsForZSet.intersectAndStore(key, otherKeys,
				destKey);
	}
